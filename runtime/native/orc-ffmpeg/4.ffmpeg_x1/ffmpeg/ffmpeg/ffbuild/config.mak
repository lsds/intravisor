...
CC_IDENT=Apple clang version 14.0.0 (clang-1400.0.29.102)
ARCH=aarch64
INTRINSICS=neon
CC=gcc
CXX=g++
...
CFLAGS=   -std=c11 -mdynamic-no-pic -fomit-frame-pointer -fPIC -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=   -mdynamic-no-pic -fPIC -Qunused-arguments
...
EXTRALIBS=-lm  -framework CoreGraphics -framework CoreImage -framework AVFoundation -framework AppKit 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
