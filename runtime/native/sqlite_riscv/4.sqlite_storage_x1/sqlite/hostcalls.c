...
#else
	return (int) c_out_2(1, (long) ptr, (long) size, 0);
#endif
}

int host_get_sc_caps(int me, int they, void *ptr) {
	return c_out_2(702, me, they, ptr);
}
...
#else
	return c_out_2(800, (long) ptr, (long) ptr2, 0);
#endif
...
int host_lstat(const char *pathname, struct stat *statbuf) {
	return (int) c_out_2(801, (long) pathname, (long) statbuf, 0);
}
int host_stat(const char *pathname, struct stat *statbuf) {
	return c_out_2(806, (long) pathname, (long) statbuf, 0);
}
int host_fstat(int fd, struct stat *statbuf) {
	return c_out_2(807, fd, (long) statbuf, 0);
}

int host_unlink(const char *pathname) {
	return (int) c_out_2(802, (long) pathname, 0, 0);
}
int host_close(int fd) {
	return (int) c_out_2(803, fd, 0, 0);
}
int host_access(const char *pathname, int mode) {
	return (int) c_out_2(804, (long) pathname, mode, 0);
}

int host_truncate(const char *path, size_t length) {
	return c_out_2(808, (long) path, length, 0);
}
__ssize_t host_read(int fd, void *buf, size_t count) {
	return c_out_2(809, fd, (long) buf, count);
}
__ssize_t host_write(int fd, const void *buf, size_t count) {
	return c_out_2(810, fd, (long) buf, count);
}
int host_open(const char *pathname, int flags, mode_t mode) {
	return c_out_2(811, (long) pathname, flags, mode);
}

off_t host_lseek(int fd, off_t offset, int whence) {
	return (off_t) c_out_2(812, fd, offset, whence);
}

int host_get_errno() {
	return c_out_2(813, 0, 0, 0);
}

int host_fcntl(int fd, int cmd, long *ptr ) {
	return c_out_2(814, fd, cmd, ptr);
}
...
int host_cap_prb(char *key, void *location) {
	...
	return (int) a0; 
#else
	return c_out_2(406, (long) key, (long) location, 0);
#endif
}
...
int host_get_my_inner(void *ptr) {
	...
	return (int) a0;
#else
	return c_out_2(700, (long) ptr, 0, 0);
#endif
}