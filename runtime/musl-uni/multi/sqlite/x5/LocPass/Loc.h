...
struct LocalisePass : public llvm::PassInfoMixin<LocalisePass> {
  llvm::PreservedAnalyses run(llvm::Module &M,
                              llvm::ModuleAnalysisManager &);
  void translatePointer(llvm::IRBuilder<> &builder, llvm::BasicBlock *bb, llvm::Instruction *I, llvm::Value *operand, int reg);
  bool visit_load(llvm::Function *F, llvm::BasicBlock *bb, llvm::Instruction *I);
  bool visit_meminst(llvm::Function *F, llvm::BasicBlock *bb, llvm::Instruction *I);
  bool visit_meminst2(llvm::Function *F, llvm::BasicBlock *bb, llvm::Instruction *I);
  ...
  llvm::CallInst* void_3;
  llvm::CallInst* call_inst_off;
  llvm::CallInst* call_inst_cap;
};