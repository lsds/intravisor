...
void *av_realloc(__intcap_t *ptr, size_t size)
{
    __intcap_t *ret;
#else
...
#ifdef __CHERI_PURE_CAPABILITY__
int av_reallocp(__intcap_t *ptr, size_t size)
{
    __intcap_t *val;
#else
...
#ifdef __CHERI_PURE_CAPABILITY__
void *av_realloc_array(__intcap_t *ptr, size_t nmemb, size_t size)
#else
...
#ifdef __CHERI_PURE_CAPABILITY__
int av_reallocp_array(__intcap_t *ptr, size_t nmemb, size_t size)
...
#ifdef __CHERI_PURE_CAPABILITY__
int av_dynarray_add_nofree(__intcap_t *tab_ptr, int *nb_ptr, void *elem)
{
    __intcap_t **tab;
#else
...
#ifdef __CHERI_PURE_CAPABILITY__
void av_dynarray_add(__intcap_t *tab_ptr, int *nb_ptr, void *elem)
{
    __intcap_t **tab;
#else
...
#ifdef __CHERI_PURE_CAPABILITY__
static inline void fast_malloc(__intcap_t *ptr, unsigned int *size, size_t min_size, int zero_realloc)
{
    size_t max_size;
    __intcap_t *val;
#else
