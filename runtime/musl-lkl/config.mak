...
ifndef CONFIG_KERNEL_CONFIGURED_DDC_RELATIVE
$(error LKL on Arm requires DD/PCC-relative addressing )
endif
endif

ifndef CONFIG_LKL
$(error LKL is not enabled in Intravisor)
endif
...
CLANG_LD_EXTRA_FLAGS="$(CC_LKL_FLAGS)"
CLANG_EXTRA_FLAGS="$(CC_LKL_FLAGS)"
...
MUSL_CONFIGURE_OPTS ?=
MUSL_CFLAGS ?= -fPIC -D__USE_GNU ${CC_MON_FLAGS}
