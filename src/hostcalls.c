...
//	printf("%p starting thread[%d]: [%lx -- %lx], func = %p, arg = %p\n",me, me->id, (long)me->stack, (long)me->stack+me->stack_size, me->func, me->arg);
	...
	if(me->sbox->pure) 
		ccap = pure_codecap_create((void *) me->sbox->cmp_begin, (void *) me->sbox->cmp_end);
	else
		ccap = codecap_create((void *) me->sbox->cmp_begin, (void *) me->sbox->cmp_end);
...
//TOD: this is very unreliable. we need to use precise bottom of the stack here
		sp_cap = datacap_create((void *) me->stack, (unsigned long) me->stack  + (unsigned long) me->stack_size);
