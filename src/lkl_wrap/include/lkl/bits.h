// Generated using tools/lkl_bits.c , changes will be overwritten
...
#undef   SYS_fanotify_init
#define __NR_fanotify_init 262
#define  SYS_fanotify_init __NR_fanotify_init
#undef  __NR_fanotify_mark
#undef   SYS_fanotify_mark
...
#undef   SYS_finit_module
#define __NR_finit_module 273
#define  SYS_finit_module __NR_finit_module
#undef  __NR_flistxattr
#undef   SYS_flistxattr
...
#undef   SYS_io_destroy
#define __NR_io_destroy 1
#define  SYS_io_destroy __NR_io_destroy
#undef  __NR_io_getevents
#undef   SYS_io_getevents
...
#undef   SYS_mq_timedreceive
#define __NR_mq_timedreceive 183
#define  SYS_mq_timedreceive __NR_mq_timedreceive
#undef  __NR_mq_timedsend
#undef   SYS_mq_timedsend
...
#undef   SYS_remap_file_pages
#define __NR_remap_file_pages 234
#define  SYS_remap_file_pages __NR_remap_file_pages
#undef  __NR_removexattr
#undef   SYS_removexattr
...
#undef   SYS_request_key
#define __NR_request_key 218
#define  SYS_request_key __NR_request_key
#undef  __NR_restart_syscall
#undef   SYS_restart_syscall
...
#undef   SYS_arch_prctl
#define __NR_arch_prctl 244
#define  SYS_arch_prctl __NR_arch_prctl
#undef  __NR_iopl
#undef   SYS_iopl
#define __NR_iopl 245
#define  SYS_iopl __NR_iopl
#undef  __NR_ioperm
#undef   SYS_ioperm
#define __NR_ioperm 246
#define  SYS_ioperm __NR_ioperm
#undef  __NR_getcpu
#undef   SYS_getcpu
#define __NR_getcpu 247
