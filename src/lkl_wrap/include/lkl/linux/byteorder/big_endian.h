...
{
	return (__lkl__le64)__lkl__swab64p(p);
}
...
{
	return (__lkl__le32)__lkl__swab32p(p);
}
...
{
	return (__lkl__le16)__lkl__swab16p(p);
}
...
#define __lkl__cpu_to_le64s(x) __lkl__swab64s((x))
#define __lkl__le64_to_cpus(x) __lkl__swab64s((x))
#define __lkl__cpu_to_le32s(x) __lkl__swab32s((x))
#define __lkl__le32_to_cpus(x) __lkl__swab32s((x))
