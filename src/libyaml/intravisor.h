...
enum state {
	...
	STATE_FCALLBACK_IN,	/* cvm cb in value */
	STATE_FCALLBACK_OUT,	/* cvm cb out value */
	STATE_FWAIT,		/* cvm wait value */
	STATE_FCR,		/* cvm clean_room value */
	STATE_FLV,		/* cvm LibVirt value */
///
